...
syn keyword SverilogType	enum struct union rand randc
...
syn keyword SverilogStatement   before bind break buf bufif0 bufif1 byte
...
syn keyword SverilogStatement   export extends extern final first_match
...
syn keyword SverilogStatement   specify specparam strong0 strong1
...
syn keyword SverilogStatement   type typedef unique var virtual
...
syn keyword SverilogRepeat      forever repeat while for
...
"syn match   SverilogGlobal "`[a-zA-Z0-9_]\+\>"
...
syn match   SverilogNumber "\(\<\d\+\|\)'[bB]\s*[0-1_xXzZ?]\+\>"
syn match   SverilogNumber "\(\<\d\+\|\)'[oO]\s*[0-7_xXzZ?]\+\>"
syn match   SverilogNumber "\(\<\d\+\|\)'[dD]\s*[0-9_xXzZ?]\+\>"
syn match   SverilogNumber "\(\<\d\+\|\)'[hH]\s*[0-9a-fA-F_xXzZ?]\+\>"
